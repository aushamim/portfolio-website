...
import pro1p1 from "../../Media/project-2-p1.jpg";
import pro1p2 from "../../Media/project-2-p2.jpg";
import pro1p3 from "../../Media/project-2-p3.jpg";

const Project02 = () => {
  return (
    <Container className="font mt-5">
      <h1 className="text-center  ">
        Cars<span className="heading"> BD</span>
      </h1>
      <Container className=" mt-5 p-5 project-bg project-container project  ">
        <Row>
          <Col sm={12} md={6} lg={6}>
            <h2 className="fw-bold text-center mb-2">Description</h2>
            <h5 className="text-secondary">A place to get a dream car. </h5>

            <li>User can buy a car.</li>
            <li>User can cancel an order.</li>
            <li>Admin can Add and Delete a Car.</li>
            <h5 className="mt-2">
              Frontend:{" "}
              <span>
                {" "}
            ...
            <h5>
              ...
              <span>
                ...
                <a
                  className="link-btn badge bg-warning m-1"
                  href="https://github.com/aushamim/cars-bd-server"
                  target="_blank"
                  rel="noreferrer"
                >
                  Server Side
